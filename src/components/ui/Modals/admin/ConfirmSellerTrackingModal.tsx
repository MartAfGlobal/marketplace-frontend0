...
interface ConfirmSellerTrackingModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  loading?: boolean;
...
export default function ConfirmSellerTrackingModal({
  isOpen,
  onClose,
  onConfirm,
  loading = false,
  ...
  logisticsCompany,
  trackingNumber,
}: ConfirmSellerTrackingModalProps) {
        ...
        <div className="p-8 space-y-8">
          <div className="text-center space-y-1">
            ...
            <p className="text-xs text-000000/68 font-MontserratNormal leading-[16px]">
              Cross check the tracking number for verification
            </p>
          </div>
