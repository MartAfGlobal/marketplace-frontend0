  ...
  return (
    <Link href={`/product/${product.slug}`}  passHref>
      <motion.div
        ...
        className="rounded-lg shadow-custom w-full h-66 shadow overflow-hidden cursor-pointer"
      >
        ...
        <div className="flex justify-between p-4 items-end">
          ...
          <button
            ...
            className="w-[44px] h-[41.97px] flex items-center justify-center gap-2 py-1 bg-[#FF715B] rounded-[8px]"
          >
