    ...
    <div>
      {onOpenFilter && (
        <button
          ...
          className={` hidden md:flex circle-shadow text-c12 font-MontserratNormal text-ff715b bg-ffffff items-center w-full max-w-fit p-3 rounded-xl justify-center flex-shrink-0 gap-4.5 h-10 ${isIncomplete? "cursor-not-allowed" : "cursor-pointer"}`}
        >
          <span>Filter</span>
