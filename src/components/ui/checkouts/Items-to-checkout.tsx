         ...
         <div className="pt-c48 pb-c64 ">
          <div className=" ">
            <div className="flex gap-18 justify-center ">
              <div className=" w-full pb-c32 max-w-207">
                <div className=" border-b border-b-000000/5 pb-c32 mb-c32">
                  <div className="pb-c32 justify-between flex ">
                  ...
                  <motion.div
                    ...
                    className=" w-full h-fit flex gap-c24"
                  >
                ...
                <div className="w-full ">
                 <div className="pb-c32 border-b border-b-000000/5">
                   <UserAddress className="w-64.25 h-31 " />
                 </div>
                <div className="pb-c32 border-b border-b-000000/5 mt-c32">
