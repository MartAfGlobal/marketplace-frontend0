export default function ProductDetailsSkeleton() {
  return (
    <div>
      <div className="flex items-center mb-c32 gap-6">
        <div className="bg-gray-200 animate-pulse  w-2.25 h-4 " />

        <div className="text-base bg-gray-200 animate-pulse font-MontserratSemiBold w-40 h-3" />
      </div>
