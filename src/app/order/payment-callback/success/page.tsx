...
function OrderPaymentSuccessContent() {
  ...
  // If order data is missing (e.g. direct link or page reload), fetch it via reference
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <Image src={WnavRight} alt=">" width={16} height={16} />
          <span className="font-MontserratMedium text-c12">Order Confirmed</span>
        </nav>
      </motion.div>
