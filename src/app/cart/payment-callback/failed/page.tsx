...
function PaymentFailedContent() {
  ...
  // If order details are missing and ref exists, attempt to fetch order info for context
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <Image src={WnavRight} alt=">" width={16} height={16} />
          <span className="font-MontserratMedium text-c12 text-red-500">Failed</span>
        </nav>
      </motion.div>
