...
function LoginForm() {
  ...
  const [authStep, setAuthStep] = useState<'verify'|'checkinbox'|'forgot'|'reset'|'updated'|'done'>("verify");
  ...
  const handleSignUpSuccess = () => setAuthStep("checkinbox");
  const handleGoogleSignInPopup = () => setAuthStep("checkinbox");
  const handleVerifyBack = () => setAuthOpen(false);
  const handleCheckInboxBack = () => setAuthOpen(false);
  const handleForgotBack = () => setAuthOpen(false);
  const handleResetBack = () => setAuthOpen(false);
  const handlePasswordUpdatedBack = () => setAuthOpen(false);
          ...
          <div className="w-full max-w-sm">
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-600">Sign in to start enjoying our services</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {isLoading || isGoogleLoading ? (
                    <span className="text-sm text-[#FF715B] font-medium cursor-not-allowed opacity-50">
                      Forgot password?
                    </span>
                  ) : (
                    <Link 
                      href="/forgot-password"
                      className="text-sm text-[#FF715B] font-medium hover:underline"
                    >
                      Forgot password?
                    </Link>
                  )}
